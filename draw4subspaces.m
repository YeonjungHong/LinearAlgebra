...
N = span_the_space(N_basis, 5000,1);
R = span_the_space(R_basis, 5000,1);
R_whole = span_the_space([N_basis R_basis], 5000,1);

C = span_the_space(C_basis, 5000,1);
leftN = span_the_space(leftN_basis, 5000,1);
C_whole = span_the_space([C_basis leftN_basis], 5000,1);
